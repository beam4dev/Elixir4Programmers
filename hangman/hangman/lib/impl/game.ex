defmodule Hangman.Impl.Game do
  ...
  @spec make_move(t, String.t) :: {t, Type.tally}
  def make_move(game , guess) when guess >= "a" and guess <= "z"
  do
    accept_guess(game, guess, MapSet.member?(game.used, guess))
    |> return_with_tally()
  end

  @spec make_move(t, String.t) :: {atom, String.t}
  def make_move(_game , guess)
  do
    {:error, "A guess is a single lowercase ASCII character a..z"}
  end
  ...
  def tally(game) do
   %{
    ...
    letters:    reveal_guessed_letter(game),
  ...
  defp reveal_guessed_letter(game =%{game_state: :lost} ) do
    game.letters
  end

  defp reveal_guessed_letter(game) do
    game.letters
